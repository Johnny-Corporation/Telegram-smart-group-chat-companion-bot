...
def inline_mode_settings(message):
    ...
    gpt_answers_additional_settings_button = types.InlineKeyboardButton(
        text=templates[language_code][
            "button_inline_mode_model_additional_settings.txt"
        ],
        callback_data="inline_mode_model_additional_settings",
    )
    ...
    gpt_answers_button = types.InlineKeyboardButton(
        text=templates[language_code]["button_inline_mode_model.txt"].format(
            smile=smile
        ),
        callback_data="inline_mode_model",
    )
    ...
    google_button = types.InlineKeyboardButton(
        text=templates[language_code]["button_inline_mode_google.txt"].format(
            smile=smile
        ),
        callback_data="inline_mode_google",
    )
    smile = "❌"
    if groups[message.chat.id].inline_mode == "Youtube":
        smile = "✅"
    youtube_button = types.InlineKeyboardButton(
        text=templates[language_code]["button_inline_mode_youtube.txt"].format(
            smile=smile
        ),
        callback_data="inline_mode_youtube",
    )
