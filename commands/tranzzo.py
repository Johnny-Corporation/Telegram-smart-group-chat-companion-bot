...
def send_invoice(message):
    ...
    bot.send_invoice(message.chat.id, title, description, invoice_payload, provider_token, start_parameter, currency, prices, photo_url=photo_url)
...
def create_invoice(message):
    ...
    bot.send_invoice(message.chat.id, title, description, invoice_payload, provider_token, currency, prices[0], photo_url=photo_url)
